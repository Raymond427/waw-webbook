...
export default ({ className, id, highlight, highlightColor, defaultColor, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} id={id} style={{fill: highlight ? highlightColor : 'var(--secondary-background-color)', width: '30px', height: '30px'}} onClick={onClick} tabIndex='0'>
